...
import { MockInterviewer } from "@/components/dashboard/mock-interviewer"
...
export function DashboardProgress({
  ...
  return (
    <div className="relative mx-auto flex w-full min-w-0 max-w-7xl flex-col gap-8 overflow-x-clip">
      <div
        aria-hidden
