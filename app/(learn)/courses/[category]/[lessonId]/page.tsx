...
export default async function LessonPage({ params }: LessonPageProps) {
  ...
  return (
    <article className="mx-auto flex w-full min-w-0 max-w-7xl flex-col gap-8">
      <header className="space-y-3">
        ...
        <h1 className="font-heading text-3xl font-semibold tracking-tight text-slate-900 sm:text-4xl dark:text-slate-50">
          {lesson.title}
        </h1>
